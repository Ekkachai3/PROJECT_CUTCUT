...
//Switch Routes Pages
import 'package:loginsystem/src/pages/about_page.dart';
import 'package:loginsystem/src/pages/gallery_page.dart';
import 'package:loginsystem/src/pages/profile_page.dart';
    ...
    return Container(
      child: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.photo), title: Text('Galeria')),
          BottomNavigationBarItem(
              icon: Icon(Icons.perm_identity), title: Text('Perfil')),
          BottomNavigationBarItem(
              icon: Icon(Icons.info_outline), title: Text('Acerca')),
        ],
        onTap: (int index) {
          setState(() {
            _currentIndex = index;
